        ...
        <div className="report-fullwidth-container">
          ...
          <div className="report-fullwidth-section">
            <div className="section-fullwidth-image">
              <img
                src="/aek/assets/report-traffic.jpg"
                alt="교통 개선 활동"
              />
            </div>
          ...
          <div className="report-fullwidth-section">
            <div className="section-fullwidth-image">
              <img src="/aek/assets/report-safety.jpg" alt="안전 정책 활동" />
            </div>
            <div className="section-fullwidth-content">
              <div className="section-header">
          ...
          <div className="report-fullwidth-section">
            <div className="section-fullwidth-image">
              <img
                src="/aek/assets/report-welfare.jpg"
                alt="복지 정책 활동"
              />
            </div>
            <div className="section-fullwidth-content">
          ...
          <div className="report-fullwidth-section">
            <div className="section-fullwidth-image">
              <img src="/aek/assets/report-growth.jpg" alt="지역 성장 활동" />
            </div>
            <div className="section-fullwidth-content">
              <div className="section-header">
